package tn.esprit.stockservice.config;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/stocks/**").hasAnyRole("ADMIN", "CLIENT")
                        .requestMatchers(HttpMethod.POST, "/api/v1/stocks/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/stocks/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/stocks/**").hasRole("ADMIN")
