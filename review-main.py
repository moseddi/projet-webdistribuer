...
# Config
EUREKA_URL = os.environ.get("EUREKA_URL", "http://localhost:8761/eureka/apps/review-service")
SERVICE_HOST = os.environ.get("SERVICE_HOST", "review-service")
    ...
    while True:
        try:
            response = requests.post(
                ...
                json={
                    "instance": {
                        "instanceId": f"{SERVICE_HOST}:{SERVICE_PORT}",
            ...
            print(f"✅ Registered with Eureka: {response.status_code}", flush=True)
